  ...
  return (
    <div className={classes["post-container"]}>
      ...
      <div className={classes["post-content"]}>
        <div>
          <p className={classes["user-post-info"]}>
            {username}{" "}
            <span className={classes["user-post-handle"]}>
              {userHandle} • {postTime}
            </span>
          </p>
        </div>
        ...
        <div>
          <p className={classes["user-post__content"]}>{postContent}</p>
        </div>

        <div className={classes["post-interaction"]}>
          <p className={classes["post-icon"]}>
          ...
          <p className={classes["post-icon"]}>
            ...
            ></i>{" "}
            {postInteraction.retweets}
          </p>
          <p className={classes["post-icon"]}>
            <i
              id="likes"
              className="far fa-heart"
              onClick={() => dispatch({ type: "UPDATE_LIKES" })}
            ></i>{" "}
